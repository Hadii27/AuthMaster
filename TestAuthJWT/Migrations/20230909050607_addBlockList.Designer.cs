...
namespace TestAuthJWT.Migrations
{
    ...
    [Migration("20230909050607_addBlockList")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthMaster.Model.BlockList", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuthMaster.Model.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuthMaster.Model.OrderItems", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TestAuthJWT.Model.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AuthMaster.Model.OrderItems", b =>
                {
                    b.HasOne("AuthMaster.Model.Order", "order")
                        .WithMany("orderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AuthMaster.Model.ProductModel", "product")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TestAuthJWT.Model.ApplicationUser", null)
                        .WithMany()
